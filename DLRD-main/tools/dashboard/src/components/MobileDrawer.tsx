          ...
          <section>
            ...
            <div className="flex flex-wrap gap-1.5">
              {filterDefs.map((cat) => {
                ...
                // CODE and DATA map to node types this backend emits; the rest
                // are future (v2) node kinds, shown disabled with a "soon" marker.
                const isSoon =
                ...
                return (
                  <button
                    ...
                    disabled={isSoon}
                    title={isSoon ? t.common.comingSoon : undefined}
