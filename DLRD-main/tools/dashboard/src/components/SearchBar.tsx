      ...
      <div className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-surface border-b border-border-subtle">
        ...
        <div className="flex items-center gap-1 bg-elevated rounded-lg p-0.5 shrink-0">
          ...
          <button
            ...
            className="text-[10px] px-1.5 py-0.5 rounded text-text-muted/50 cursor-not-allowed flex items-center gap-1"
          >
            {t.search.semantic}
            <span className="text-[8px] lowercase opacity-70">{t.common.soon}</span>
          </button>
        </div>
        {searchQuery.trim() && (
