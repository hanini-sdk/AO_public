export const en = {
  common: {
    ...
    appName: "Data-Lineage and Retro-Documentation",
  ...
  fileExplorer: {
    ...
    clusterizeTitle: "Group graph nodes into folder/cluster boxes (off = flat graph)",
    hierarchy: "Tree",
    hierarchyTitle: "Group graph nodes by directory-tree path, one box per folder (off = flat graph; mutually exclusive with Clusterize)",
    missingData: "Missing data",
    missingDataTitle: "Show placeholder nodes for scripts/SQL files referenced but not found in the project (off by default)",
  },
  focusPrompt: {
    largeTitle: "This project is large",
    nodesSuffix: "nodes — too large to render all at once.",
    instruction: "Pick a variable, table, column or file to view its lineage.",
    searchPlaceholder: "Search for a variable, table, column or file…",
  ...
  personaSelector: {
    ...
    learn: "Learn",
    learnDesc: "Read the project story — a narrative walkthrough of the project",
    deepDive: "Deep Dive",
  ...
  detailLevel: {
    ...
    fn: "fn",
    columns: "Col",
    columnsTitle: "Show table columns as nodes attached to their table",
    columnsNeedsTable: "Enable TABLE first — columns live inside tables",
  },
  nodeTypeLabels: {
    all: "All",
    code: "Code",
  ...
  learnPanel: {
    ...
    next: "Next",
    prev: "Prev",
    noTour: "Guided tours — coming in a future version",
    noTourHint: "This feature is planned for a future release.",
    ...
    regenerateTitle: "Rebuild the story from the current graph",
    closeStory: "Close",
    generating: "Writing the project story…",
    storyError: "Could not generate the project story.",
    storyEmpty: "No story content is available for this project yet.",
    retry: "Try again",
  },
  layer: {
    defaultName: "Layer",
  ...
  export: {
    ...
    asStoryPDF: "Export Story as PDF",
  },
  edgeLabels: {
  ...
  onboarding: {
    header: "DATA-LINEAGE AND RETRO-DOCUMENTATION · GET STARTED",
    ...
    steps: [
      {
        ...
        body: "The dots and lines you see are entities and relations extracted from this project. A node can be a file, class, or function from the code — or a concept, entity, or claim from a knowledge wiki.",
